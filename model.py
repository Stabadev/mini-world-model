...
class Encoder(nn.Module):
    """
    Encode une image 7×7 en vecteur latent de dimension latent_dim.
...
class ActionEncoder(nn.Module):
    ...
    def __init__(self, n_actions=4, latent_dim=16):
        super().__init__()
...
class WorldModel(nn.Module):
    ...
    def forward(self, obs, action):
        """
        obs    : (batch, 1, 7, 7) — image actuelle
